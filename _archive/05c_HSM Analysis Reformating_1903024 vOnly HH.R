...
# Note for March 24 Cycle: We are going to keep the KI Level results and HH Level results fully independent from each other
# so I'm commenting out some code below
...
# ki_level_results <- read_excel("08_results_table/ki_level/results_table_Tue_Mar_19_2024_161039.xlsx")
...
combined_results <- hh_level_results %>%
